...
func InitLogger(cfg *LogConfig) (err error) {
	...
	writeSyncError := getLogWriter(cfg.ErrorFileName, cfg.MaxSize, cfg.MaxBackups, cfg.MaxAge)
	encoder := getEncoder()
	...
	errorCore := zapcore.NewCore(encoder, writeSyncError, zapcore.ErrorLevel)
